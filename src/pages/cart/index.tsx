                            ...
                            >
                                ...
                                <div className='flex flex-col justify-between w-full px-3'>
                                    ...
                                    <div className='flex flex-row justify-between items-center gap-x-2 mt-1'>
                                        <p className='text-sm mt-[2px] text-sky-500 font-medium'>Quantidade: <span className="text-base text-black">{item.selectedQuantity}kg</span></p>
                                        <p className='text-sm mt-[2px] text-sky-500 font-medium'>Total: <span className="text-base text-black">R$ {(item.unitValue * Number(item.selectedQuantity)).toFixed(2).replace('.', ',')}</span></p>
                                    </div>
                                </div>
                            </div>
                        )
