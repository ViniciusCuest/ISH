            ...
            <section className="flex flex-col">
                ...
                <form action="" className="flex flex-col space-y-5 px-5">
                    ...
                    <span className="w-full px-2 relative flex items-center flex-row bg-white h-8 shadow-[0px_4px_5px_0px_#0000001c] rounded-lg">
                        <input
                            className="block h-full w-full outline-none text-gray-400"
                    ...
                    <footer className="flex flex-row justify-between">
                        ...
                        >
                            <input type="checkbox" />
                            <p className="text-xs">Li e aceito a <span className="text-sky-500 font-medium">politica de privacidade</span></p>
                        </label>
