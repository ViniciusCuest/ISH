            ...
            <section className="flex overflow-x-auto space-x-4">
               {
                  data.map((item) => (
                     <div key={item.id} className="flex flex-col items-center gap-y-2 flex-none">
                        <img
                           className="object-cover relative h-[90px] w-[98px] rounded-xl"
                           src={item.img}
                           alt=""
                        />
                        <h6>{item.title}</h6>
                  ...
                  cards.map((item) => (
                     <div className="flex flex-row justify-between p-2 shadow-[0px_4px_5px_0px_#0000001c] w-full rounded-xl" key={item.id}>
                           ...
                           <div className="flex flex-row gap-x-2">
                              ...
                              <span>
                                 <div>
                                    ...
                                    <h4 className="text-lg text-sky-500 font-medium">{item.title} | {item.weight ? `${item.weight}Kg` : `${item.units} unidades`}</h4>
                                 </div>
                        ...
                        <div className="flex flex-col space-y-[50%] items-end">
                           ...
                           <Button title="Pedir" size="small" onPress={() => { }} />
                        </div>
                     </div>
                  ))
               }
